...
public class NewsletterReceiversTest extends AbstractBridgedComponentTestCase {
  private NewsletterReceivers comp;

  @Before
  public void setUp_NewsletterReceiversTest() throws Exception {
//    comp = new NewsletterReceivers(, getContext());
  }
